...
#ifndef _FAST_DDS_GENERATED_PERSON_FACE_DETECTION_MSG_PERSONFACE_H_
#define _FAST_DDS_GENERATED_PERSON_FACE_DETECTION_MSG_PERSONFACE_H_
...
#error \
    Generated PersonFace is not compatible with current installed Fast DDS. Please, regenerate it with fastddsgen.
#endif  // GEN_API_VER
...
class PersonFace : public eprosima::fastdds::dds::TopicDataType {
 public:
   ...
   * @param x Reference to the object person_face_detection::msg::PersonFace
   * that will be copied.
   */
   ...
   * @param x person_face_detection::msg::PersonFace object to compare.
   */
...
#endif  // _FAST_DDS_GENERATED_PERSON_FACE_DETECTION_MSG_PERSONFACE_H_
