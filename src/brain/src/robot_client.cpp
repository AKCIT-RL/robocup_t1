...
int RobotClient::squatAction(booster_internal::robot::b1::SquatDirection direction)
{
    using namespace booster_internal::robot::b1;
    booster_interface::msg::BoosterApiReqMsg msg;
    msg.api_id = static_cast<int64_t>(booster_internal::robot::b1::LocoInternalApiId::kSquatAction);

    SquatParameter squat_action(direction);
    msg.body = squat_action.ToJson().dump();

    return call(msg);
}

int RobotClient::goalieSquatDown(booster_internal::robot::b1::SquatDirection direction,
                                 booster_internal::robot::b1::SquatSide side)
{
    using namespace booster_internal::robot::b1;
    booster_interface::msg::BoosterApiReqMsg msg;
    msg.api_id = static_cast<int64_t>(LocoInternalApiId::kGoalieSquatDown);

    GoalieSquatDownParameter goalie_squat_down_param(direction, side);
    msg.body = goalie_squat_down_param.ToJson().dump();

    return call(msg);
}

int RobotClient::enableVisualKickMode()
{
    using namespace booster_internal::robot::b1;
    booster_interface::msg::BoosterApiReqMsg msg;
    msg.api_id = static_cast<int64_t>(LocoInternalApiId::kEnableVisualKickMode);
    msg.body = "{}";

    return call(msg);
}

int RobotClient::rlKickBall(float kick_speed, float kick_dir)
{
    using namespace booster_internal::robot::b1;
    booster_interface::msg::BoosterApiReqMsg msg;
...
int RobotClient::fancyKick(float kick_speed, float kick_dir)
{
    using namespace booster_internal::robot::b1;
    booster_interface::msg::BoosterApiReqMsg msg;
...
int32_t RobotClient::moveToTargetWithKick(float x, float y, float yaw) 
{
    using namespace booster_internal::robot::b1;
    MoveToTargetParameter move(x, y, yaw, true);

    booster_interface::msg::BoosterApiReqMsg msg;
    msg.api_id = static_cast<int64_t>(LocoInternalApiId::kMoveToTargetInternal);
    msg.body = move.ToJson().dump();
