...
public:
    ...
    bool tmImAlive = true; 
    double tmMyCost = 0.;
    rclcpp::Time leadSwitchTimer;

    bool doingPenaltyKick;
    Point2D ballPosDuringPenalty;

    bool doingKickingOff;
    Point2D ballPosDuringKickingOff;
