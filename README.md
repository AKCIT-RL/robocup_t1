...
Reference [Robocup Project Installation Guide](https://zabo9hes6ge.feishu.cn/wiki/OERXwKIZoiJmNJkUe00cM3zvnY6)

## File Directory Structure Description

```
└── robocup // repository main directory
    ├── build  //  directory automatically generated by colcon tool, no need to manage it
    ├── install //  directory automatically generated by colcon tool, no need to manage it
    ├── log // directory automatically generated by colcon tool, no need to manage it
    └── src // ros2 node code are all placed here
        └── brain // robocup strategy code
            ├── config  // configuration file directory
                ├── behavior_trees  // all behaviorTree configuration files are placed here
                    ├── test.xml  // specific configuration file
                        ...
                ├── config.yaml  // ros2 configuration file, will be loaded by python files under launch
                    ...
            ├── include  // project header files
                ...
                ├── brain_log.h
                    ...
            ├── launch  // ros2 launch configuration file
                ├── test_launch.py  // specific launch file, inside there are also corresponding configuration values
                        ...
...
```bash
docker buildx build -f docker/dockerfile.jetson -t robocup_demo_v2:1.0 . --load
